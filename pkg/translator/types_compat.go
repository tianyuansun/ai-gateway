...
// ---- Anthropic types (used by test files) ----
...
func parseJSON(s string) any { var v any; json.Unmarshal([]byte(s), &v); return v }

// ---- DEPRECATED: retained for test compatibility (Slice 6 will remove) ----
